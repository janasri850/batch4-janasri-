...
#if char=="a"  or char =='e'  or char =='i' or char =='o' or char =='y':
#    print("is a vowel")
#else:
#    print("its consenent")
...
# ? Eg:1
# to print the value from 1to 10 using for loop
...
# ? Eg:5
# break --> used to terminal the loop
...
# ? to iterate the non literable elements while loop is used
